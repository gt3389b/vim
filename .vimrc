...
" Vim UI {
  ...
  "  set cursorline " highlight current line
    ...
    set linespace=0 " don't insert any extra pixel lines
                     " betweens rows
  "  set list " we do want to show tabs, to ensure we get them
              " out of my files
...
" Text Formatting/Layout {
    ...
    set shiftwidth=3 " auto-indent amount when using cindent,
                      " >>, << and stuff like that
    set softtabstop=3 " when hitting tab or backspace, how many spaces
                       "should a tab be (see expandtab)
    set tabstop=3 " real tabs should be 8, and they will show with
                   " set list on
" }
